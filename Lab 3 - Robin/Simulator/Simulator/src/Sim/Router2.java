...
public class Router2 extends SimEnt{
	...
	public void changeInterface(int oldInterfaceNumber, int newInterfaceNumber){
	...
	{
		System.out.println("REEEEEEE" + event);
	if (event instanceof Message)
		{
			...
			for ( int i = 0 ; i < _interfaces; i++){
				System.out.println("ROUTING : "+_routingTable[i]);
			}
